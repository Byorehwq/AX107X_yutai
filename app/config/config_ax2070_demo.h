/*****************************************************************************
 * Module    : Config
 * File      : config_ax2070_demo.h
 * Author    : Hanny
 * Email     : coldney@163.com
 * Function  : AX2070 DEMO板功能配置
 *****************************************************************************/
#ifndef CONFIG_AX2070_DEMO_H
#define CONFIG_AX2070_DEMO_H
...
*/
#define SRAM_DEBUG                      1   //是否开启SRAM板调试功能

//pll trim值
#define PLL_INTL                        0x05  //请手动填写
#define PLL_FRACL                       0x08  //请手动填写
#define PLL_FRACH                       0x67  //请手动填写

//三合一trim值
#define LED_TRIM                        0x10  //请手动填写
 ...
 * Task      : AUX任务的功能定义
 *****************************************************************************/
#define AUX_EQ_EN                       0   //是否使用带有EQ功能的LINEIN
...
#define USB_DOWNLOAD_FLASH              0   //是否连PC可以下载文件到flash
...
#define ENERGY_DISP_EN                  0   //是否需要能量显示
...
//记忆体选择
#define SYS_MEM                         MEM_RTCRAM


/*****************************************************************************
 * Module    : DAC、AMUX相关配置定义
 *****************************************************************************/
#define DAC_FADE_EN                     1   //是否需要DAC濙入淡出

#define DAC_POWER_SPEED                 0   //是否需要减少DAC初始化占用的开机时间，打开会增加100多字节

//可省DAC输出电容，耳机检测需要使用ADC检测，开内部上拉10K）
#define DAC_BUF_EN                      0   //是否使用VCM BUF（只在AX107X上可选), 这里是207x所以必须为0

//DAC初始化选择
#define DAC_INIT_TYPE                   DAC_VCM_WITH_CAP//DAC_VCM_WITH_CAP
...
//新增P07模拟WKO    wq creat 2017/05/11
//#define P07_IO_SET
//#define P07_PORT                       P0
//#define P07_DIR                        P0DIR
//#define P07_CHECK_PU                   PUP0
//#define P07_PIN                        7
